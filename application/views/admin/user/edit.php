        ...
        <div class="widget-main no-padding">
          <?php foreach($userinfo as $user):?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text"  id="form-field-1" placeholder="username" name="username" value="<?php echo $user->username;?>" class="col-xs-10 col-sm-5" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  <input type="text" id="form-field-1-1" placeholder="userpass"name="userpass"value="<?php echo $user->userpass;?>"  class="col-xs-10 col-sm-5" />
              </div>
            </div>
            ...
            <div class="row" id="row_dim">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-4" placeholder="memberemail" name="memberemail" value="<?php echo $user->memberemail;?>" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
