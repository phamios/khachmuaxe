      ...
      <div class="widget-body">
        <div class="widget-main no-padding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  <input type="text" id="form-field-1-1" placeholder="userpass" class="col-xs-10 col-sm-5" />
              </div>
            </div>
            ...
            <div class="row" id="row_dim">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-2" placeholder="fullname" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-3" placeholder="memberphone" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-4" placeholder="memberemail" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-4" placeholder="showroom" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-4" placeholder="memberaddress" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" id="form-field-1-5" placeholder="balance" class="col-xs-10 col-sm-5" />
                      </div>
                    </div>
             </div>
